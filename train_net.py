...
from PoisDenoiser.nnLayers.functional import poisLLHLoss, PerceptualLoss
...
save_path = './PoisDenoiser/networks/PoisNet/models/'+opt.save_path_app+'/'
...
BSDStrain = BSDS500(path2dataset+'train/', num_images=num_images, do_VST=do_VST)
BSDStrain_loader = DataLoader(BSDStrain, batch_size=train_batchsize, \
    shuffle=True, num_workers=0)

BSDSval = BSDS500(path2dataset+'val/', do_VST=do_VST)
...
training_procedure(start_epoch, epochs, model, model_type,\
                    ...
                    BSDStrain_loader, BSDSval_loader, \
